...
def DisplayRecentScores(RecentScores):
  ...
  for Count in range(1, NO_OF_RECENT_SCORES + 1):
    print("{0:<10} {1:<10} {2}".format(RecentScores[Count].Name, RecentScores[Count].Score, RecentScores[Count].Time))
  print()
...
def UpdateRecentScores(RecentScores, Score):
  add = input("would you like too add your score to the table? y/n: ")
  if add == "y":
    PlayerName = GetPlayerName()
    actual_time = datetime.now()
    Formattedtime = datetime.strftime(actual_time, "%d-%m-%y")
    FoundSpace = False
    Count = 1
    ...
    if not FoundSpace:
      for Count in range(1, NO_OF_RECENT_SCORES):
        ...
        RecentScores[Count].Time = RecentScores[Count + 1].Formattedtime
      Count = NO_OF_RECENT_SCORES
    RecentScores[Count].Name = PlayerName
    RecentScores[Count].Score = Score
    RecentScores[Count].Time = Formattedtime
  elif add == "n":
